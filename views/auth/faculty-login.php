    ...
    <div class="login-split">
        ...
        <div class="flex items-center justify-center p-8 lg:p-12">
            <div class="w-full max-w-md">
                ...
                <?php endif; ?>
                <form id="login-form" method="post" action="<?= APP_URL ?>/login/faculty" class="space-y-5">
                    <div>
                ...
                <p class="text-center mt-4">
                    <a href="<?= APP_URL ?>/forgot-password/faculty" class="text-sm text-emerald-600 hover:underline">Forgot password?</a>
                </p>
