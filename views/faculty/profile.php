...
<div class="max-w-4xl mx-auto space-y-6">
    <!-- Profile Header -->
    <div class="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl p-6 sm:p-8 relative overflow-hidden">
        ...
        <div class="relative flex flex-col sm:flex-row items-center gap-5">
            ...
            <div class="text-center sm:text-left">
                ...
                <div class="flex flex-wrap gap-2 mt-3 justify-center sm:justify-start">
                    <span id="hero-dept" class="px-3 py-1 bg-white/20 text-white text-xs rounded-full"><i class="fas fa-building mr-1"></i>Faculty</span>
                    <span class="px-3 py-1 bg-green-400/30 text-green-100 text-xs rounded-full"><i class="fas fa-check-circle mr-1"></i>Active</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-emerald-50 to-teal-50 px-6 py-4 border-b"><h3 class="font-semibold text-gray-900 flex items-center gap-2"><i class="fas fa-user text-emerald-600"></i> Personal Information</h3></div>
            <form id="profile-form" class="p-6 space-y-4">
                <div><label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Full Name</label>
                    <input type="text" id="p-name" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 outline-none"></div>
                <div><label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Email</label>
                    <input type="email" id="p-email" disabled class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm bg-gray-50 text-gray-500"></div>
                <div><label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Phone</label>
                    <input type="text" id="p-phone" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 outline-none"></div>
                <button type="submit" id="save-profile-btn" class="w-full py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-lg text-sm font-medium"><i class="fas fa-save mr-2"></i>Save Changes</button>
            </form>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <form id="password-form" class="p-6 space-y-4">
                <div><label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Current Password</label>
                    <input type="password" id="pw-current" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-amber-500 outline-none"></div>
                <div><label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">New Password</label>
                    <input type="password" id="pw-new" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-amber-500 outline-none"></div>
                <div><label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Confirm Password</label>
                    <input type="password" id="pw-confirm" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-amber-500 outline-none"></div>
...
async function loadProfile() {
    ...
    const d = data.data;
    document.getElementById('hero-name').textContent = d.name || 'Faculty';
